...
class PersonasController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $p->fecha_ingreso = $request->fecha_ingreso;
        $p->fecha_nacimiento = $request->fecha_nacimiento;
        $p->sexo = $request->sexo;
        $p->estado_civil = $request->estado_civil;
        $p->instruccion = $request->instruccion;
        $p->ocupacion = $request->ocupacion;
        $p->condicion_fisica = $request->condicion_fisica;
        $p->condicion_psicologica = $request->condicion_psicologica;
        $p->estado_salud = $request->estado_salud;
        $p->vino_voluntad_propia = $request->vino_voluntad_propia;
        $p->vino_voluntad_propia_especifique = $request->vino_voluntad_propia_especifique;
        $p->recibe_algun_beneficio = $request->recibe_algun_beneficio;
        $p->vive_con = $request->vive_con;
        $p->num_personas_vive_con = $request->num_personas_vive_con;
        $p->nombre_personas_vive_con = implode(";",$request->nombre_personas_vive_con);
        $p->parentesco_vive_con = implode(";",$request->parentesco_vive_con);
        $p->calidad_relaciones = $request->calidad_relaciones;
        $p->calidad_relaciones_especifique = $request->calidad_relaciones_especifique;
        $p->observaciones = $request->observaciones;
        $p->responsable1 = $request->responsable1;
        $p->responsable2 = $request->responsable2;
